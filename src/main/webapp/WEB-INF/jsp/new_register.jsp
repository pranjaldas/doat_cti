                ...
                <form class="register-form" id="register-form" method="POST" action="/saveregistration" object="registration" >
                    ...
                    <div class="form-row" id="register_home">
                        ...
                        <div class="col-6 mb-3">
                            <label for="phone"><strong>Phone number </strong><strong><sup style="color: red; size: A5">*</sup></strong></label>
                            <input class="form-control "   type="" name="phone"  id="phone" placeholder="Phone number" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"required maxlength="10">
                        ...
                        <div class="col-6 mb-3">
                            <label for="datepicker"><strong>Date of Birth </strong><strong><sup style="color: red; size: A5">*</sup></strong></label>
                        ...
                        <div class="col-6 mb-3">
                            <label for="password"><strong>Password </strong><strong><sup style="color: red; size: A5">*</sup></strong></label>
                            <input class="form-control " type="password" id="password" name="password"  placeholder="Enter password" required>


                        </div>
                        <div class="col-6 mb-3">
                            <label for="conpassword"><strong>Confirm Password </strong><strong><sup style="color: red; size: A5">*</sup></strong></label>
                            <input class="form-control datepicker " type="password" id="conpassword"  placeholder="Enter password" required>
