        ...
        <div class="container mb-3 ">
                    ...
                    <nav>
                        <div class="nav nav-tabs  nav-justified" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><strong>STEP-1</strong></a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><strong>STEP-2</strong></a>
                            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"><strong>STEP-3</strong></a>
                            <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false"><strong>STEP-4</strong></a>
                        </div>
                    </nav>
                                    ...
                                    <form>
                                        ...
                                        <div class="form-row">
                                         ...
                                         <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="file" name="f[]" id="hslc"  accept="image/*" onchange="validateImage('hslc')" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span id="errorName5" style="color: red;"></span>
                                                <span id="" style="color:black;"></span>
                                         ...
                                         <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="file" name="f[]" id="hs"  accept="image/*" onchange="validateImage('hs')" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span id="errorName5" style="color: red;"></span>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="file" name="f[]" id="degree"  accept="image/*" onchange="validateImage('degree')" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span id="errorName5" style="color: red;"></span>
                                                <span  style="color:black;"></span>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="file" name="f[]" id="disability"  accept="image/*" onchange="validateImage('disability')" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span id="errorName5" style="color: red;"></span>
                                                <span style="color:black;"></span>
                                         ...
                                         <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="file" name="f[]" id="experience"  accept="image/*" onchange="validateImage('experience')" >
                                            </div>
                                            <div class="form-group col-md-4">
                                                <span id="errorName5" style="color: red;"></span>
                                                <span style="color:black;"></span>
