          ...
          <div class="card-body">
            ...
            <div class="form-row" id="register_home">
              ...
              <div class="col-6 mb-11">
                ...
                <select class="custom-select text-uppercase caste" id="dept_name" name="job_title" required>
              ...
              <div class="col-6 mb-3">
                <label for="text"><strong>Employee Number: </strong><strong><sup
                      style="color: red; size: A5">*</sup></strong></label>
                <input class="form-control " type="text" id="empid" name="empid" placeholder="EmpId" required>
