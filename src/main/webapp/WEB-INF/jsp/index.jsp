          ...
          <div class="tab-pane" id="register">
              ...
              <div class="container" id="con">
                  ...
                  <div class="alert alert-danger" id="failure-alert" role="alert">
                      <button type="button" class="close" data-dismiss="alert">x</button>
                      <strong>Opps!</strong> <a href="#" class="alert-link">Some thing went wront, may be email is not valid, change a few things
                          up</a> and
                                  ...
                                  <div class="col-6 mb-3">
                                      ...
                                      <input class="form-control " type="Enter email" id="email" name="email"
                                        ...
                                        <div class="alert alert-danger" id="used-email-failure-alert" role="alert">
                                            ...
                                            <strong>Opps!</strong> <a href="#" class="alert-link">This email is already registered</a> 
                                        </div>   
